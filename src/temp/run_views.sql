...
as resposta,
    ...
    left join graph_respostaobjetiva as resp
...
where pergunta.titulo =
      'Você considera satisfatória a atuação do IFG para promoção da permanência e êxito dos/das estudantes?'
  and part.resposta != 'N/A';
...
where pergunta.titulo =
      'De maneira geral, você é bem atendido/a nos setores de atendimento ao/à discente/docente no IFG?'
  and part.resposta != 'N/A';
