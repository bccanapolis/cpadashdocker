...
from .models import Pessoa, Curso, Campus, Eixo, Pergunta, Segmento, Grafico, Atuacao, Dimensao, ParticipacaoPergunta, CursoCampus, PerguntaSegmento, RespostaObjetiva
